...
try:
    ...
    print("Failed to initialized NDI. Could not open " + os.path.join(basedir, "bin", f"Processing.NDI.Lib.{arch}.dll. Please download the DLL file or use the release instead."))
    sys.exit()
